...
from sam_lp.datasets.dataset_ufpr_sam import (
    UFPR_ALPR_Dataset,
    UFPR_ALPR_Dataset,
    SamTransform,
    SamTransformTest,
...
from sam_lp.lora.lora_predictor import LoRA_SamPredictor
    ...
    for i_batch, sample_batch in tqdm(enumerate(testloader)):
        ...
        with torch.no_grad():
            ...
            results = cv2.addWeighted(
                image_np, 1.0, show_mask * 255, 0.5, 0, 0, cv2.CV_32F
            )
