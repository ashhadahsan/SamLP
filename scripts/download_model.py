...
import os
def download_model():
    check_point_url="https://dl.fbaipublicfiles.com/segment_anything/sam_vit_b_01ec64.pth"
    ...
    if not os.path.exists(cpkt_path):
        ...
        print("If this is your second time traning the model, make sure to use the latest .pth file under exp path")